          ...
          >
            <div>
              ...
              <p className="text-slate-500 text-sm sm:text-base mt-1 max-w-xl font-medium">
                Earn reward points on every purchase and redeem them instantly
                during checkout.
              </p>
            </div>
            ...
            >
              ...
              <div>
                ...
                <h2 className="text-4xl sm:text-5xl font-black text-[#2A4150] mt-2 tracking-tight">
                  ...
                  <span className="text-sm font-bold text-slate-400 ml-1.5 tracking-normal">
                    pts
                  </span>
                </h2>
            ...
            >
              ...
              <div>
                ...
                <h2 className="text-4xl sm:text-5xl font-black text-amber-500 mt-2 tracking-tight">
                  ...
                  <span className="text-sm font-bold text-amber-400 ml-1.5 tracking-normal">
                    pts
                  </span>
                </h2>
            ...
            <div className="border-b border-slate-100 px-6 py-5 flex items-center justify-between bg-slate-50/50">
              <div>
                ...
                <p className="text-xs text-slate-400 font-medium mt-0.5">
                  Detailed log of your points activity
                </p>
              </div>
            ...
            {history.length === 0 ? (
              <div className="py-16 text-center">
                ...
                <p className="text-slate-400 text-xs mt-1 max-w-[240px] mx-auto">
                  Your rewards ledger is empty. Start shopping to trigger your
                  first entry!
                </p>
              </div>
            ) : (
                  ...
                  {history.map((item, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {/* Points Counter */}
                        <div
                          className={`font-black text-sm sm:text-base shrink-0 ml-4 border px-3 py-1 rounded-xl transition-all ${
                            isEarned
